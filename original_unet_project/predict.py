"""Prediction entry point for U-Net segmentation checkpoints."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Predict masks for one image or an image folder.")
    parser.add_argument("--input", type=Path, required=True, help="Image file or folder.")
    parser.add_argument("--checkpoint", type=Path, default=DEFAULT_CHECKPOINT)
    parser.add_argument("--output-dir", type=Path, default=DEFAULT_RUNS_DIR / "predict")
...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    for image_path in image_paths:
        ...
        prob_image = probability_to_rgb(probability)
